...
DDL (Data Definition Language): criação e estruturação das tabelas, chaves primárias, chaves estrangeiras e restrições.

DML (Data Manipulation Language): inserção e manipulação de dados para fins de teste e simulação do sistema.

DQL (Data Query Language): consultas para recuperação e análise das informações, simulando operações reais de um sistema hoteleiro, como gestão de reservas, clientes, quartos e pagamentos.

Este projeto reflete na prática todo o processo de modelagem de dados, desde a concepção conceitual até a implementação física em banco de dados relacional.
